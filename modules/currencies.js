export const currency_list = [
  ...
  { name: 'Mongolian TÃ¶grÃ¶g', code: 'MNT' },
  ...
  { name: 'Paraguayan GuaranÃ­', code: 'PYG' },
  ...
  { name: 'SÃ£o TomÃ© and PrÃ­ncipe Dobra', code: 'STN' },
  ...
  { name: 'Tongan PaÊ»anga', code: 'TOP' },
  { name: 'Turkish Lira', code: 'TRY' },
  { name: 'Trinidad and Tobago Dollar', code: 'TTD' },
  { name: 'Tuvaluan Dollar', code: 'TVD' },
  ...
  { name: 'Venezuelan BolÃ­var Soberano', code: 'VES' },
  { name: 'Vietnamese Äá»“ng', code: 'VND' },
  { name: 'Vanuatu Vatu', code: 'VUV' },
  { name: 'Samoan TÄlÄ', code: 'WST' },
